...
export default function ColorCircle(props: any) {
    return (
        <div className="relative inline-flex flex-col self-center hover:bg-gray-300 transition-colors place-items-center align-center w-12 h-12 justify-center rounded-md" onClick={() => props.onSelect(props.color)}>
            <div>
