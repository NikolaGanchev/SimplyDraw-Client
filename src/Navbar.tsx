...
export default function Navbar() {
    ...
    return (
        <div className="fixed left-0 right-0 top-0 flex h-12 shadow-md bg-white dark:bg-gray-900 dark:text-white fill-current overflow-x-scroll overflow-y-hidden small:overflow-visible z-20">
